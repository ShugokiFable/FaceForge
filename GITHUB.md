...
| **Current ship tree** | `FaceForge 0.23.1/` (see `CURRENT.txt`) |
...
- `FaceForge 0.23.1/` source, scripts, README, VERSION, qa (no `bin/`, `obj/`, `dist/`, `node_modules/`, `artifacts/`, MediaPipe wasm copies)
- Root `README.md`, `CHANGELOG.txt`, `CURRENT.txt`, `PLAN.md`, `STATE.md`, `VALIDATION.md`, `DECISIONS.md`, `REQUIREMENTS.md`, `ROADMAP.md`, `WORKSPACE_OWNERSHIP.md`, `GITHUB.md`, `release-notes-0.23.1.md`
...
```powershell
gh release create v0.23.1 `
  --title "FaceForge 0.23.1" `
  --notes-file release-notes-0.23.1.md `
