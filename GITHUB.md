...
| **Current ship tree** | `FaceForge 0.11.0/` (see `CURRENT.txt`) |
...
- `FaceForge 0.11.0/` source, scripts, README, VERSION, qa (no `bin/`, `obj/`, `dist/`, `node_modules/`, `artifacts/`)
- Root `README.md`, `CHANGELOG.txt`, `CURRENT.txt`, `PLAN.md`, `STATE.md`, `VALIDATION.md`, `DECISIONS.md`, `REQUIREMENTS.md`, `ROADMAP.md`, `WORKSPACE_OWNERSHIP.md`, `GITHUB.md`
...
4. **Exclude:** secrets (`.env`, API keys), `bin/`, `obj/`, `node_modules/`, `dist/`, `artifacts/`, `MEMORY/`, superseded version folders, game masters.
...
gh release create v0.11.0 `
  --title "FaceForge 0.11.0" `
  --notes-file release-notes-0.11.0.md `
  "path\to\FaceForge 0.11.0 - STANDALONE.exe"
```
