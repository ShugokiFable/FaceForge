...
/** Head-part slots a player actually picks in RaceMenu, in the order that panel shows them. */
...
const fitsSex = (sex: AppearanceSex, target: TargetSex) =>
 ...
 * plugins, not that the part is valid for nothing. Unresolved parts stay visible and are labelled.
 */
const fitsRace = (validRaces: readonly string[], target: string | null) =>
...
export default function OutputPanel({
  ...
  const [appearanceCategory, setAppearanceCategory] =
    useState<AppearanceCategory>("brows");
    ...
    <section className="workspace-panel output-panel">
      ...
      <div className="guidance-card target-actor">
        ...
        <p className="guidance-caveat">
          ...
          and it is written into the export README. It does not change the generated sliders.
        </p>
      </div>
      ...
      <div className="guidance-card appearance-guidance">
        ...
        {visibleAppearanceChoices.length > 0 ? (
          <div className="appearance-list">
            {visibleAppearanceChoices.map(({ item, nameScore }) => {
              ...
              return (
                <button
                  type="button"
                  className={`appearance-recommendation appearance-choice ${selected ? "selected" : ""}`}
                ...
                >
                  ...
                  <small>
                    {nameScore > 0 ? "Name supports the photo target" : item.matchEvidence}
                  </small>
                </button>
              );
            })}
        ...
        <p className="guidance-caveat">
          ...
          come from its flags and ValidRaces form list — not from its name. The selected FormID is
          written into the JSlot. Numeric names still cannot prove shape; confirm them visually in
          RaceMenu. Skin/body replacers are deliberately not treated as face choices.
        </p>
      </div>
      ...
      <div className="output-mode-block">
        ...
        <div className="baked-head-step">
          <p>
            A JSlot is not a head. Follower Forge lists a face only once Skyrim has baked the
        ...
        <p className="guidance-caveat">
          ...
          placement, equipment, spells, perks, and an NPC plugin built in Follower Forge.
        </p>
      </div>
      ...
      <div className="guidance-card preset-report">
        ...
        {presetReport ? (
          ...
          <p>
            ...
            installed here, and whether the file is safe to share or hand to Follower Forge.
          </p>
        )}
        <button
          type="button"
