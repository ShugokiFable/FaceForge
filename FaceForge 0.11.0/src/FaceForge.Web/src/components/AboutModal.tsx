  ...
  return (
    <div className="modal-backdrop" role="presentation" onMouseDown={onClose}>
      ...
      >
        ...
        <p>
          Version 0.11.0 is a standalone app. Face analysis stays local unless you
        ...
        <div className="settings-section">
          <div className="settings-section-heading">
            ...
            >
              <ScanIcon />
              {isIndexing ? "Indexing…" : environment ? "Re-index" : "Index Data"}
            </button>
          </div>
          {environment ? (
            <>
                ...
                >
                  {environment.presets.map((preset) => (
                    <option value={preset.id} key={preset.id}>
                      {preset.fileName} · {preset.hasNif && preset.hasDds ? "trio" : "JSlot only"}
                    </option>
                  ))}
                </select>
                <button
            ...
            <div className="vision-fields">
              ...
              {usesOfficialCli ? (
                <div className="provider-card">
                  ...
                  <p>
                    FaceForge runs the provider’s official CLI. Login tokens remain
                    under that CLI’s control and are never copied into FaceForge.
                  </p>
                </div>
              ) : (
                <>
              ...
              <div className="privacy-box">
                Subscriptions are not unlimited: the provider’s current plan quotas and
