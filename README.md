# FaceForge 0.23.2 — Windows tool (not a Skyrim mod)
...
| File | What it is |
|------|------------|
| `FaceForge-0.23.2-STANDALONE.exe` | The whole tool (double-click to run) |
...
2. Double-click **`FaceForge-0.23.2-STANDALONE.exe`**.
...
---
Developers: ship tree is `FaceForge 0.23.2\`. See CURRENT.txt, build.ps1, package.ps1.
