...
export default function App() {
        ...
        heldSliders > 0
          ...
          : measured.correction.notes.length > 0
            ...
            : assessedStyle.kind === "stylized"
              ...
              : `Local photo analysis complete.${hphNotes[0] ? ` ${hphNotes[0]}` : " Review the editable values or use optional vision refinement."}`
      );
    } catch (reason) {
  ...
  useEffect(() => {
    ...
    const hphNote = highPolyHeadActive
      ? " High Poly Head calibration on (stronger EFM response + midface baselines)."
      : "";
    setNotice(
      foundation
