...
try
{
    ...
    File.WriteAllText(Path.Combine(pluginDir, "morphs.ini"), """
        #Female
        extension = Actors\Character\Character Assets\FemaleHeadChargen.tri, Fake\Fits.tri
    ...
    Console.WriteLine($"Assertions: 92 | Presets: {catalog.Summary.PresetCount} | Plugins: {catalog.Summary.PluginCount}");
}
finally
{
