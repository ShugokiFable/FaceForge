# FaceForge 0.23.1 — Windows tool (not a Skyrim mod)
...
| File | What it is |
|------|------------|
| `FaceForge-0.23.1-STANDALONE.exe` | The whole tool (double-click to run) |
...
2. Double-click **`FaceForge-0.23.1-STANDALONE.exe`**.
...
Release: https://github.com/ShugokiFable/FaceForge/releases/tag/v0.23.1