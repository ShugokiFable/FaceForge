# FaceForge 0.24.3 — Windows tool (not a Skyrim mod)
...
| File | What it is |
|------|------------|
| `FaceForge-0.24.3-STANDALONE.exe` | The whole tool (double-click to run) |
...
Release: https://github.com/ShugokiFable/FaceForge/releases/tag/v0.24.3